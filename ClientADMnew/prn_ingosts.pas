...
type
  Tfr_ingost_prn = class(TForm)
    ...
    procedure lb_Print(sender: TObject; var Value: String);
  private
...
procedure Tfr_ingost_prn.lb_Print(sender: TObject; var Value: String);
var
  sst : string;
begin
  If cds_report.Active Then Begin
     sst:=cds_report.FieldByName('REGNOM').AsString;
     While Length(sst)<6 Do sst:='0'+sst;
     Value:=sst;
  end;
end;
